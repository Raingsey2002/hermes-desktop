    ...
    <div className="layout-shell">
      <div className={`layout ${sidebarCollapsed ? "sidebar-collapsed" : ""}`}>
        ...
        <main className="content">
          ...
          {/* Skills works in every connection mode: local reads/writes the
              profile's skills directly, remote/SSH route through the
              gateway API — no RemoteNotice gate needed here. */}
